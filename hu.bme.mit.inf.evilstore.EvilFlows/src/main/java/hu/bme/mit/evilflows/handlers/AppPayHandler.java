...
public class AppPayHandler implements WorkItemHandler {
	...
	public void executeWorkItem(WorkItem wi, WorkItemManager wim) {
		...
		String accountid =   wi.getParameter("AccountID").toString();
		Integer ammount = (Integer)wi.getParameter("Ammount");
		...
		try {
			...
			WebResource webResource = client.resource(address+"/"+
					...
					URLEncoder.encode(new ObjectMapper().writeValueAsString(ammount), "UTF-8"));
			String ret = "";
