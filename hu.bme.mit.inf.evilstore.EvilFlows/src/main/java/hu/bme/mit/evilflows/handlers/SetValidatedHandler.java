...
public class SetValidatedHandler implements WorkItemHandler {
	...
	public void executeWorkItem(WorkItem wi, WorkItemManager wim) {
		...
		Boolean isvalid =   (Boolean) wi.getParameter("IsValid");
		String method =  wi.getParameter("Method").toString();

		try {
			Client client = Client.create();
			WebResource webResource = client.resource(address+"/"+appid+"/"+isvalid);
			String ret = "";
