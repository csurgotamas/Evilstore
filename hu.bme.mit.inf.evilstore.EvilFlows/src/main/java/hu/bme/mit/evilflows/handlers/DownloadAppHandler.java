...
public class DownloadAppHandler implements WorkItemHandler {
	...
	public void executeWorkItem(WorkItem wi, WorkItemManager wim) {
		...
		String appid =   wi.getParameter("AppId").toString();
		String method =  wi.getParameter("Method").toString();

		try {
			Client client = Client.create();
			WebResource webResource = client.resource(address+"/"+appid);
			String ret = "";
