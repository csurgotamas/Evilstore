 ...
 * <ul>
 *   <li>{@link evilsystem.impl.NamedObjectImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NamedObjectImpl extends EObjectImpl implements NamedObject {
	...
	protected EClass eStaticClass() {
		return EvilsystemPackage.Literals.NAMED_OBJECT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EvilsystemPackage.NAMED_OBJECT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EvilsystemPackage.NAMED_OBJECT__NAME:
				return getName();
		}
