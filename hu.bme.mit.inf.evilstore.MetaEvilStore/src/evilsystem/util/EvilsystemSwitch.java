 ...
 * @generated
 */
public class EvilsystemSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EvilsystemPackage.SYSTEM: {
				evilsystem.System system = (evilsystem.System)theEObject;
			...
			case EvilsystemPackage.SIMPLE_TYPE: {
				...
				if (result == null) result = casePackageElement(simpleType);
				if (result == null) result = caseType(simpleType);
				if (result == null) result = caseNamedObject(simpleType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EvilsystemPackage.ATTRIBUTE: {
				...
				if (result == null) result = caseTypeReference(attribute);
			...
			case EvilsystemPackage.FUNCTION: {
				...
				if (result == null) result = caseTypeReference(function);
			...
			case EvilsystemPackage.PARAMETER: {
				...
				if (result == null) result = caseTypeReference(parameter);
			...
			case EvilsystemPackage.PACKAGE_ELEMENT: {
				...
				if (result == null) result = caseNamedObject(packageElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EvilsystemPackage.TYPE_REFERENCE: {
				...
				if (result == null) result = caseNamedObject(typeReference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EvilsystemPackage.COMPONENT: {
				...
				if (result == null) result = casePackageElement(component);
				if (result == null) result = caseNamedObject(component);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EvilsystemPackage.NAMED_QUERY: {
				...
				if (result == null) result = caseNamedObject(namedQuery);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseSystem(evilsystem.System object) {
		return null;
	}
